...
class AddRecipeView extends View {
  ...
  _addHandlerShowWindow() {
    this._btnOpen && this._btnOpen.addEventListener('click', this.toggleWindow.bind(this));
  }

  _addHandlerHideWindow() {
    this._btnClose && this._btnClose.addEventListener('click', this.toggleWindow.bind(this));
    this._overlay && this._overlay.addEventListener('click', this.toggleWindow.bind(this));
  }
